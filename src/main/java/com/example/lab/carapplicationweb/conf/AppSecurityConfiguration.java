...
import com.example.lab.carapplicationweb.services.impl.AppUserDetailsService;
                ...
                .authorizeHttpRequests(
                        authorizeHttpRequests ->
                                authorizeHttpRequests.
                                        ...
                                        .permitAll().
                                        requestMatchers("/", "/users/login", "/users/register", "/users/login-error", "/pic/**", "/css/bootstrap.css","/css/bootstrap.min.css", "/static/**")
                                        .permitAll().
